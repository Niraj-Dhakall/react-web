    ...
    <nav className="sticky top-0 z-50 backdrop-blur-lg bg-black/30 border-b border-neutral-800 text-white">
      <div className="container mx-auto px-4">
        <div className="flex items-center py-3">
          <img
            className="hidden md:block mr-2 w-6 h-6"
            alt="Niraj Dhakal Logo"
            src="https://i.imgur.com/142Glwu.png"
          />
          <a
            href="/"
            className="hidden md:flex mr-6 px-2 font-mono font-bold tracking-widest text-xl text-white no-underline hover:text-gray-300"
          >
            Niraj Dhakal
          </a>
