...
import { useTheme as useNextTheme } from 'next-themes' // Import from next-themes
import { FiSun, FiMoon } from 'react-icons/fi'

export default function ThemeSwitch() {
  const [mounted, setMounted] = useState(false)
  const { theme, setTheme } = useNextTheme() // Use next-themes hook
  ...
  if (!mounted) return null // Don't render anything if not mounted
